...
class MyTestCase(unittest.TestCase):
    ...
    def test_post_succcessful_id_status(self):
        response = self.app.post('/api/1.0/time-converter/add/?id=1&lat=-33.865143&lng=151.209900&timestamp=1480933800', )
    ...
    def test_post_fail_id_status(self):
        response = self.app.post('/api/1.0/time-converter/add/?id=0&lat=-33.865143&lng=151.209900&timestamp=1480933800', )
